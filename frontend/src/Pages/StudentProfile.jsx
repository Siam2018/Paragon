...
const StudentProfile = () => {
  ...
  const fetchStudentById = async (studentId) => {
    try {
      ...
      const response = await axios.get(`${BACKEND_URL}/admin/Admin/Student/${studentId}`, {
        headers: {
  ...
  const handlePhotoUpload = async () => {
    ...
    try {
      ...
      const response = await fetch(`${BACKEND_URL}/admin/Student/photo/${student._id}`, {
        method: 'PUT',
        headers: {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${BACKEND_URL}/admin/Student/password/${student._id}`, {
        method: 'PUT',
        headers: {
